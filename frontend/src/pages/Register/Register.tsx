    ...
    try {
      const payload = {
        ...
        religiousEducationInfo: {
          ...
          testimonyMessage: formData.testimonyMessage,
          pastorName: formData.pastorName,
          pastorAddress: formData.pastorAddress,
          secondarySchool: formData.secondarySchool,
          secondarySchoolDates: formData.secondarySchoolDates,
          secondarySchoolCertificates: formData.secondarySchoolCertificates,
          collegeSchool: formData.collegeSchool,
          collegeSchoolDates: formData.collegeSchoolDates,
          collegeSchoolCertificates: formData.collegeSchoolCertificates
        },
        ...
        enrollmentInfo: {
          ...
          department: formData.studentDiscipline,
          currentOccupation: formData.currentOccupation,
          sponsorship: formData.studentSponsor,
          pastorName: formData.enrollPastorName,
          relationshipWithPastor: formData.enrollPastorRelationship,
          nextOfKinName: formData.enrollKinName,
          relationshipWithNextOfKin: formData.enrollKinRelationship
        }
      };
