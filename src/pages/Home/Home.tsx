      ...
      <section className="py-12 md:py-16 lg:py-20 px-4 md:px-6 lg:px-8 bg-red-900 text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-red-100 mb-12 max-w-2xl">
            Ready to transform your life through faith-based education? Explore
            our admission pathways and find the program that fits your calling.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {admissionPaths.map((path, index) => (
              <div
                key={index}
                className="bg-white bg-opacity-10 p-6 rounded-lg border border-white border-opacity-20 hover:bg-opacity-20 transition"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg mb-8">
                Access your grades, course materials, and communicate with
